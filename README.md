...
`Python` `Gurobi` `pandas` `NumPy` `scikit-learn` `PyTorch` `SQL` `Excel`

### 📬 Reach Me

[LinkedIn](https://www.linkedin.com/in/jayesh-yevale/) · [Email](mailto:jayesh.v.yevale@gmail.com)
...
**JayeshYevale/JayeshYevale** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
